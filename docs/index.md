...
MapLibre GL JS is also distributed via UNPKG. Our latest version can be installed by adding below tags this in the html `<head>`. Further instructions on how to select specific versions and semver ranges can be found on at [unpkg.com](https://unpkg.com).
